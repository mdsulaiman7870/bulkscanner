...
urlpatterns = [
    ...
    path('abuseipdb_dashboard', views.abuseipdb_dashboard,
         name='abuseipdb_dashboard'),

    path('delete_vt_api/<int:id>', views.delete_vt_api, name='delete_vt_api'),
    path('delete_abuseipdb_api/<int:id>',
         views.delete_abuseipdb_api, name='delete_abuseipdb_api'),

    path('delete_column/<str:column_name>',
