...
urlpatterns = [
    ...
    path('malicious_ips', views.abuseipdb_malicious_ips,
         name='abuseipdb_malicious_ips'),
    ...
    path('delete_from_all_ips/<str:ip>', views.delete_ip,
         name='abuseipdb_delete_from_allips'),
