...
urlpatterns = [
    ...
    path('delete_from_all_ips/<str:ip>',
         views.delete_ip, name='delete_from_allips'),
    ...
    path('delete_from_all_hashes/<str:hash>',
         views.delete_hash, name='delete_from_all_hashes'),
    ...
    path('search_malicious_ips', views.search_malicious_ips,
         name='vt_search_malicious_ips'),
    path('search_all_ips', views.search_all_ips, name='vt_search_all_ips'),
    path('search_malicious_hashes', views.search_malicious_hashes,
         name='search_malicious_hashes'),
